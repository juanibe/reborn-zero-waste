				...
				<Form onSubmit={this.handleFormSubmit}>
					...
					<Form.Row>
						<Form.Group as={Col} md="6">
							...
							<Form.Control required type="text" name="logo" placeholder="Enter logo name" value={this.state.logo} onChange={e => this.handleChange(e)}/>
						</Form.Group>
						<Form.Group as={Col} md="6">
					...
					<Form.Row>
						<Form.Group as={Col} md="12">
							...
							<Form.Control required type="textarea" row="6" name="design_inspiration" placeholder="what does your brand stand for?" value={this.state.design_inspiration} onChange={e => this.handleChange(e)}/>
						</Form.Group>
					</Form.Row>
					...
					<Form.Row>
						<Form.Group as={Col} md="12">
							...
							<Form.Control required type="textarea" row="6" name="product_types" placeholder="Accessories, shoes, pants etc" value={this.state.product_types} onChange={e => this.handleChange(e)} />
						</Form.Group>
					</Form.Row>
					...
					<Form.Row>
						<Form.Group as={Col} md="12">
							...
							<Form.Control required type="text" value={this.state.image_gallery} name="image_gallery" onChange={e => this.handleChange(e)} />
						</Form.Group>
					</Form.Row>
					...
					<Form.Row>
						<Form.Group as={Col} md="12">
							...
							<Form.Check type="checkbox" label="Accessories" name="categories" id="formcategorycheckbox1"/>
							<Form.Check type="checkbox" label="Pants" name="categories" id="formcategorycheckbox2"/>
							<Form.Check type="checkbox" label="Shirts" name="categories" id="formcategorycheckbox3"/>
							<Form.Check type="checkbox" label="Jackets" name="categories" id="formcategorycheckbox4"/>
							<Form.Check type="checkbox" label="Leftover Fabric" name="categories" id="formcategorycheckbox5"/>
						</Form.Group>
					</Form.Row>
					...
					<Form.Row>
						<Form.Group as={Col} md="12">
							...
							<Form.Check type="checkbox" label="Cotton" name="source" id="formsourcecheckbox1"/>
							<Form.Check type="checkbox" label="Wool" name="source" id="formsourcecheckbox2"/>
							<Form.Check type="checkbox" label="Denim" name="source" id="formsourcecheckbox3"/>
							<Form.Check type="checkbox" label="Synthetics" name="source" id="formsourcecheckbox4"/>
							<Form.Check type="checkbox" label="Muslin" name="source" id="formsourcecheckbox5"/>
						</Form.Group>
					</Form.Row>
